...
AndroidTwitterClient is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [X] User can tap a tweet to **open a detailed tweet view**
  * [X] opens a new activity, but isn't that detailed
...
* [X] User can see embedded image media within the tweet detail view
  * [X] Currently only handles images when you uploaded a tweet with an image (so not from retweets with images). I put the images as heterogenous views in the recycler view instead of the tweet detail view
...
* [X] On the Twitter timeline, leverage the [CoordinatorLayout](http://guides.codepath.com/android/Handling-Scrolls-with-CoordinatorLayout#responding-to-scroll-events) to apply scrolling behavior that [hides / shows the toolbar](http://guides.codepath.com/android/Using-the-App-ToolBar#reacting-to-scroll).
  * [X] for some reason, my faction button doesn't go away while scrolling
...
* [X] List anything else that you can get done to improve the app functionality!
  * [X] Used Butterknife to make view code more organized

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/OHMVFHb.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
