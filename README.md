# Project 4 - Android Twitter Client

Android Twitter Client is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [X] Implements robust error handling, [check if internet is available](http://guides.codepath.com/android/Sending-and-Managing-Network-Requests#checking-for-network-connectivity), handle error cases, network failures
  * [X] I question the success of my error handling. I don't think I'm catching the errors correctly
...
<img src='http://imgur.com/hzWqeLP.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
